...
def getFKGL(sentence):
    sentence = normalize(sentence, tokenizer="13a")
    nb_words = count_words(sentence)
    nb_syllables = count_syllables_in_sentence(sentence)
    nb_sentences = 1
    return max(
        0,
        0.39 * (nb_words / nb_sentences)
        + 11.8 * (nb_syllables / nb_words)
        - 15.59,
        )
...
if __name__=="__main__":
    sentence = "this is a beautiful girl, and she is my wife."
    print(getFKGL(sentence))
